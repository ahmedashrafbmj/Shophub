...
<Navbar   expand="lg">
                        <Navbar.Brand href="#"><img src="/img/IMG-20230116-WA0042-removebg-preview.png" style={{marginLeft:"-221px",height:"54px"}}/></Navbar.Brand>
...
<a><b style={{marginLeft:"60px",border:"2px solid black",paddingLeft:"8px",paddingRight:"8px"}}>{local}</b></a>
