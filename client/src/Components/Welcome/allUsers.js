                                    ...
                                    return (
                                        ...
                                        <>
                                            <tr style={{textAlign: "center"}}>
                                                ...
                                                <td>{element.name}</td>
                                                <td>{element.role === "Admin" ? "Vendor" : "User" }
                                                <br />
...
<select id="inputState" class="form-control" onChange={ (e) =>{setproductDetail({...productDetail, accountsstatus: e.target.value })} }>
  ...
  <option>Disabled</option>
                                                ...
                                                <td class="" style={{textAlign: "center"}}>{element.email}</td>
                                                <td><img src={element.img} class="img-fluid my-4 mx-4" style={{height:"80px"}}></img></td>
                                              
                                             
                                                
                                                
                                                
                                                <td style={{textAlign: "center"}}>{element.address}</td>
                                               
                                                <td style={{textAlign: "center"}}><Button sx= {{marginRight: 5}}  variant="contained" onClick={() => deletedata(element._id)}>Delete</Button>
                                                <br />
                                                <br />
